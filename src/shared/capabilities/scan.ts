...
import { parseFrontmatter, splitList, unquote } from './frontmatter'

// Re-exported: these moved to a node-free module so the renderer can preview
// an agent file, but they are part of the scanner's tested surface.
export { parseFrontmatter, splitList }
